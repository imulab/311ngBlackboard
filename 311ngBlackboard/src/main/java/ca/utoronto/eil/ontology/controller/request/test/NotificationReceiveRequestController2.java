...
public class NotificationReceiveRequestController2 {

	private static final Logger logger = Logger.getLogger(NotificationReceiveRequestController2.class);
	@Autowired private Gson gson;
	
	/**
	 * Handles request from <application url>/rest/request/test/notification2
	 ...
	 */
	@RequestMapping(value="/notification2", method=RequestMethod.POST, produces="application/json;charset=UTF-8")
	public @ResponseBody String receiveNotification(
		...
		logger.info("+++ notification2 test request received, assigned UUID = [" + response.getUuid() + "]");
